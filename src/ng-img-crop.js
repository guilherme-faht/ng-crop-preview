  ...
  * Updated 2017 by Guilherme Faht (GURUX)
  */ 
(function() {
'use strict';
  ...
  return function(elCanvas, opts, events){
    ...
    var onMouseMove=function(e) {
      if(image!==null) {
        ...
        if(e.type === 'touchmove') {
          pageX = e.changedTouches ?  e.changedTouches[0].pageX : e.originalEvent.changedTouches[0].pageX;
          pageY = e.changedTouches ?  e.changedTouches[0].pageY : e.originalEvent.changedTouches[0].pageY;
        } else {
          pageX=e.pageX;
          pageY=e.pageY;
        }
